...
namespace Live.Love.Wed
{
    public partial class Login : System.Web.UI.Page
    {
        ...
        {
                SqlConnection con = new SqlConnection("Data Source = (LocalDB)\\MSSQLLocalDB; Initial Catalog = LiveLoveWedDB; Integrated Security = True");
                con.Open();
                SqlCommand cmd = new SqlCommand("Select * from tblClient where Username=@username and Password=@pwd", con);
