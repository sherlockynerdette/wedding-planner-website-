<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeFile="Payment.aspx.cs" Inherits="Live.Love.Wed.Payment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row" style="padding-top: 20px;">
        ...
        <div class="col-md-9">
             ...
             <div>
                                <asp:GridView ID="gvServices" runat="server" CssClass="col-md-12"  AutoGenerateColumns="false" Visible="false" CellPadding="6"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="SID" HeaderText="Service ID" />
                                        <asp:BoundField DataField="SName" HeaderText="Service Name" />
                                    </Columns>
                                </asp:GridView>                                
                            </div>
        </div>
