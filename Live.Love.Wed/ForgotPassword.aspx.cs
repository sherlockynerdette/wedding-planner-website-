...
namespace Live.Love.Wed
{
    public partial class ForgotPassword : System.Web.UI.Page
    {
        ...
        protected void btnResetPass_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("Select * from tblClient where Email=@Email", con);
                ...
                if (dt.Rows.Count != 0)
                {
                    ...
                    MailMessage PassRecMail = new MailMessage("live.love.wed@gmail.com", ToEmailAddress);
                    ...
                    using (SmtpClient client = new SmtpClient())
                    {
                        ...
                        client.Credentials = new NetworkCredential("aditi@gmail.com", "aditi@12345");
